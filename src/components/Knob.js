/**
 * Copied code from https://github.com/joshjg/react-canvas-knob
 * The library build dependencies are now deprecated
 * For the time being, it was reasonable to copy the code here.
 */
